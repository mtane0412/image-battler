...
1. **ファイターをつくる**: 画像(ペット・ぬいぐるみ・ごはん、なんでも)をアップロードして名前をつけると、Gemini Nano が画像を観察して HP・こうげき・ぼうぎょ・すばやさ・うん・二つ名・必殺技を生成します
...
| バトル進行 | `src/battle/engine.ts`(注入乱数による決定論的シミュレーション。AI はバトル結果に関与しません) |
